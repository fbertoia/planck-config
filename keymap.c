...
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,    KC_Q,    KC_W,    E_ACC,	  KC_R,    KC_T,     KC_Y,      U_ACC,         	   I_ACC,   O_ACC,   KC_P,    KC_ESC,
    KC_LCTL,   A_ACC,   KC_S,    KC_D,    KC_F,    KC_G,     KC_H,      KC_J,     		   KC_K,    KC_L,    KC_SCLN, KC_LGUI,
    KC_LSFT,   KC_Z,    KC_X,    C_ACC,    KC_V,    KC_B,     KC_N,      KC_M,     		   KC_COMM, KC_DOT,  KC_SLSH, TG(_LOWER),
    MO(ALTER), KC_LCTL, KC_LALT, KC_LGUI, LOWER,   SPC_MAJ,  SPC_MAJ,   LT(RAISE, KC_ENT), KC_LGUI, KC_LALT, KC_LCTL,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,   	   KC_LCTL,     KC_LALT,    KC_LGUI,   	_______,      SPC_MAJ,      SPC_MAJ,      LT(ADJUST, KC_ENT),    KC_LGUI, KC_LALT, KC_LCTL, KC_VOLU
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_GRV,       KC_DQUO,     KC_PIPE,    KC_LCBR,     KC_RCBR, 	_______,  KC_EXLM,  KC_AT,    KC_HASH, KC_PLUS ,  KC_LSFT,
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, _______, _______,  KC_MS_U, _______, RGB_HUI, RGB_HUD,   KC_F7,   KC_F8,    KC_F9,   KC_F10, KC_DEL ,
    _______, _______, KC_MS_L,  KC_MS_D, KC_MS_R, AG_NORM, _______,   KC_F4,   KC_F5,    KC_F6,   KC_F11,  DEBUG,
    _______, MUV_DE,  MUV_IN,   MU_ON,   MU_OFF,  MI_ON,   _______,   KC_F1,   KC_F2,    KC_F3,   KC_F12, RESET,
    RGB_TOG, RGB_MOD, RGB_HUI,  RGB_HUD, _______, _______, _______,   _______, _______,  KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ALTER] = LAYOUT_planck_grid(
    ...
    XXXXXXX, _______, _______, _______, KC_LCTL, _______, _______, KC_ENT, LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_UP), LCTL(KC_RGHT)
),

[_ACCENT] = LAYOUT_planck_grid(
    KC_ESC,  _______,  E_AIG, _______, E_GRV,   E_TRM, _______, _______, U_GRV,   I_TRM, O_TRM, _______,
    _______,  _______,  A_GRV, _______, E_CIR,   _______, _______, _______, U_CIR, I_CIR, O_CIR, _______,
    _______, _______, A_CIR, _______, C_CED, _______, _______, _______, _______, _______, _______, _______,
